...
import { ArrowRight, Compass, Globe, Zap, Cpu, User } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        disabled={loading}
        className="w-full bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-black py-4 rounded-[18px] shadow-lg shadow-emerald-500/10 transition-all active:scale-[0.98] disabled:opacity-50 text-[11px] uppercase tracking-[0.2em]"
      >
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        onClick={handleSubmit}
        disabled={loading}
        className="w-full bg-zinc-100 hover:bg-white text-zinc-950 font-black py-4 rounded-[18px] shadow-lg transition-all active:scale-[0.98] disabled:opacity-50 text-[11px] uppercase tracking-[0.2em]"
      >
